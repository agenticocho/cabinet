...
Work only inside the cabinet-scoped knowledge base rooted at /data/data/example-text-your-mom/app-development.
For local filesystem work, treat /Users/mikebird/cabinet/data/example-text-your-mom/app-development as the root for this run.
...
Job instructions:
Review the release checklist, active bug list, and current roadmap priorities.
Write a release readiness review for Text Your Mom covering:
- known blockers
- rollback risk
- notification reliability concerns
- whether this build earns user trust
Save the review in /release-checklist.